...
''' Load train set '''
data_dict = loadmat(lp_2_dataset + "LP2.mat")
...
np.save(lp_2_dataset + 'X_train.npy', X_train)
np.save(lp_2_dataset + 'y_train.npy', y_train)
np.save(lp_2_dataset + 'X_test.npy', X_test)
np.save(lp_2_dataset + 'y_test.npy', y_test)
